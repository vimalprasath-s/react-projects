...
const RestaurantCard = ({resData}) => {
    const {avgRating, cloudinaryImageId, costForTwo, cuisines, locality, name, sla, totalRatingsString, veg} = resData?.info;
    // console.log("detailsss", avgRating, cloudinaryImageId, costForTwo, cuisines, locality, name, sla, totalRatingsString, veg)
    const restroImage = name === "Spice Kingdom" ? DEFAULT_RESTAURANT_IMAGE : `${CDN_URL + cloudinaryImageId}`
    return (
